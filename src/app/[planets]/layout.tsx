  ...
  return (
    <main className="sm:grid">
      ...
      <div className="px-6 space-y-2 sm:flex sm:space-x-3">
        <div className="uppercase flex sm:flex-col px-6 sm:px-4 items-center justify-between border-[1px] border-FFFFF border-opacity-10 sm:w-full">
        ...
        <div className="uppercase flex px-6 items-center justify-between border-[1px] border-FFFFF border-opacity-10 sm:w-full">
